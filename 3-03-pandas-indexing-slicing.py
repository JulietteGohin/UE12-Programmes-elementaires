...
# %%
DF = df[['Name', 'Pclass', 'Survived']]
DF = DF.iloc[-10:] #pas de -1 sous entendu
DF
...
# %%
selection = df [np.logical_and (np.logical_not(df['Pclass'] == 1), df['Age'] >= 70)]
selection
